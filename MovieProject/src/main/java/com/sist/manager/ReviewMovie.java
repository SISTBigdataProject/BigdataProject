...
public class ReviewMovie extends Thread {
	...
	public void run() {
		...
		try {
			...
			/*
			 * int i = 1; System.out.println(i + ". title : " + title);
			 * System.out.println("code : " + code);
			 * System.out.println("rvlink : " + rvlink); i++;
			 */
			...
			for (int k = 0; k < p; k++)// p
			{
				...
				try {
					for (int j = 0; j < ervtitle.size(); j++) {
						 ...
						 */
						String link = "https://movie.naver.com/movie/bi/mi/reviewread.nhn?nid=" + linkcode + "&code="
								+ code + "&order=#tab";
